...
#define BFD_RELOC_SPARC_DISP64 BFD_RELOC_64_PCREL
  ...
  BFD_RELOC_FLARE_SET8,
  BFD_RELOC_FLARE_SET16,
  BFD_RELOC_FLARE_SET32,
  BFD_RELOC_FLARE_PSEUDO_ADD8,
  BFD_RELOC_FLARE_PSEUDO_ADD16,
  BFD_RELOC_FLARE_PSEUDO_ADD32,
  BFD_RELOC_FLARE_PSEUDO_ADD64,
  BFD_RELOC_FLARE_PSEUDO_SUB8,
  BFD_RELOC_FLARE_PSEUDO_SUB16,
  BFD_RELOC_FLARE_PSEUDO_SUB32,
  BFD_RELOC_FLARE_PSEUDO_SUB64,
  BFD_RELOC_FLARE_CFA,
  BFD_RELOC_FLARE_CFA_SET6,
  BFD_RELOC_FLARE_CFA_SUB6,
  BFD_RELOC_FLARE_EH_32_PCREL,

  /* SnowHouseCpu ELF relocations.  */
  BFD_RELOC_SNOWHOUSECPU_S16,
  BFD_RELOC_SNOWHOUSECPU_S32_FOR_S16,
  BFD_RELOC_SNOWHOUSECPU_S32_FOR_S16_ADD32,
  BFD_RELOC_SNOWHOUSECPU_S32_FOR_S16_SUB32,
  BFD_RELOC_SNOWHOUSECPU_SHIFT_U5,
  BFD_RELOC_SNOWHOUSECPU_S16_PCREL,
  BFD_RELOC_SNOWHOUSECPU_S32_FOR_S16_PCREL,
  BFD_RELOC_SNOWHOUSECPU_SET8,
  BFD_RELOC_SNOWHOUSECPU_SET16,
  BFD_RELOC_SNOWHOUSECPU_SET32,
  BFD_RELOC_SNOWHOUSECPU_PSEUDO_ADD8,
  BFD_RELOC_SNOWHOUSECPU_PSEUDO_ADD16,
  BFD_RELOC_SNOWHOUSECPU_PSEUDO_ADD32,
  BFD_RELOC_SNOWHOUSECPU_PSEUDO_ADD64,
  BFD_RELOC_SNOWHOUSECPU_PSEUDO_SUB8,
  BFD_RELOC_SNOWHOUSECPU_PSEUDO_SUB16,
  BFD_RELOC_SNOWHOUSECPU_PSEUDO_SUB32,
  BFD_RELOC_SNOWHOUSECPU_PSEUDO_SUB64,
  BFD_RELOC_SNOWHOUSECPU_CFA,
  BFD_RELOC_SNOWHOUSECPU_CFA_SET6,
  BFD_RELOC_SNOWHOUSECPU_CFA_SUB6,
  BFD_RELOC_SNOWHOUSECPU_EH_32_PCREL,
