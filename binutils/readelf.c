		  ...
		  bool is_dynsym)
{
  ...
  for (i = 0; i < rel_size; i++)
	...
	case EM_FLARE32_UNOFFICIAL:
	  rtype = elf_flare32_reloc_type (type);
	  break;
...
get_machine_name (unsigned e_machine)
{
  ...
  switch (e_machine)
    ...
    case EM_FLARE32_UNOFFICIAL:	 return "Flare32";
...
is_32bit_abs_reloc (Filedata * filedata, unsigned int reloc_type)
{
  ...
  switch (filedata->file_header.e_machine)
    ...
    case EM_FLARE32_UNOFFICIAL:
      return reloc_type == 3; /* R_FLARE32_32. */
    case EM_MSP430_OLD:
    case EM_MSP430:
...
is_none_reloc (Filedata * filedata, unsigned int reloc_type)
{
  switch (filedata->file_header.e_machine)
    ...
    case EM_FLARE32_UNOFFICIAL:  /* R_FLARE32_NONE */
