...
guess_is_rela (unsigned int e_machine)
{
  switch (e_machine)
    ...
    case EM_SNOWHOUSECPU_UNOFFICIAL:
    case EM_MSP430:
    case EM_MSP430_OLD:
    case EM_MT:
    case EM_NDS32:
		  ...
		  bool                is_dynsym)
{
  ...
  for (i = 0; i < rel_size; i++)
	...
	case EM_SNOWHOUSECPU_UNOFFICIAL:
	  rtype = elf_snowhousecpu_reloc_type (type);
	  break;
...
get_machine_name (unsigned e_machine)
{
  ...
  switch (e_machine)
    ...
    case EM_SNOWHOUSECPU_UNOFFICIAL:	 return "SnowHouseCpu";
...
is_32bit_abs_reloc (Filedata * filedata, unsigned int reloc_type)
{
  ...
  switch (filedata->file_header.e_machine)
    ...
    case EM_SNOWHOUSECPU_UNOFFICIAL:
      return reloc_type == 3; /* R_SNOWHOUSECPU_32. */
    case EM_MSP430_OLD:
    case EM_MSP430:
...
is_none_reloc (Filedata * filedata, unsigned int reloc_type)
{
  switch (filedata->file_header.e_machine)
    ...
    case EM_SNOWHOUSECPU_UNOFFICIAL: /* R_SNOWHOUSECPU_NONE */
