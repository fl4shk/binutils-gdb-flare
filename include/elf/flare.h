...
START_RELOC_NUMBERS (elf_flare32_reloc_type)
  ...
  /* -------- */
  RELOC_NUMBER (R_FLARE32_G7_ICRELOAD_S5, 21) /* no `pre`/`lpre` */
  RELOC_NUMBER (R_FLARE32_G7_ICRELOAD_S17, 22) /* `pre` */
  RELOC_NUMBER (R_FLARE32_G7_ICRELOAD_S32, 23) /* `lpre` */
  RELOC_NUMBER (R_FLARE32_G7_ICRELOAD_S32_ADD32, 24) /* local label sub */
  RELOC_NUMBER (R_FLARE32_G7_ICRELOAD_S32_SUB32, 25) /* local label sub */
  RELOC_NUMBER (R_FLARE32_G7_ICRELOAD_S32_NO_RELAX, 26) /* no relaxing */
  /* -------- */
  //RELOC_NUMBER (R_FLARE32_FDE_32_PCREL, 27) /* `.eh_frame` stuff */
  /* -------- */
  RELOC_NUMBER (R_FLARE32_SET8, 27)
  RELOC_NUMBER (R_FLARE32_SET16, 28)
  RELOC_NUMBER (R_FLARE32_SET32, 29)
  /* -------- */
  /* Local label subtraction within a pseudo-op */
  RELOC_NUMBER (R_FLARE32_PSEUDO_ADD8, 30)
  RELOC_NUMBER (R_FLARE32_PSEUDO_ADD16, 31)
  RELOC_NUMBER (R_FLARE32_PSEUDO_ADD32, 32)
  RELOC_NUMBER (R_FLARE32_PSEUDO_ADD64, 33)
  RELOC_NUMBER (R_FLARE32_PSEUDO_SUB8, 34)
  RELOC_NUMBER (R_FLARE32_PSEUDO_SUB16, 35)
  RELOC_NUMBER (R_FLARE32_PSEUDO_SUB32, 36)
  RELOC_NUMBER (R_FLARE32_PSEUDO_SUB64, 37)
  /* -------- */
  RELOC_NUMBER (R_FLARE32_CFA_SET6, 38)
  RELOC_NUMBER (R_FLARE32_CFA_SUB6, 39)
  /* -------- */
  RELOC_NUMBER (R_FLARE32_EH_32_PCREL, 40)
  /* -------- */
