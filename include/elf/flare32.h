...
START_RELOC_NUMBERS (elf_flare32_reloc_type)
  ...
  RELOC_NUMBER (R_FLARE32_G3_S32_PCREL_NO_RELAX, 13) /* no relaxing */
  /* -------- */
  //RELOC_NUMBER (R_FLARE32_FDE_32_PCREL, 14) /* `.eh_frame` stuff */
  /* -------- */
  /* Local label subtraction within a pseudo-op */
  RELOC_NUMBER (R_FLARE32_PSEUDO_ADD8, 14)
  RELOC_NUMBER (R_FLARE32_PSEUDO_ADD16, 15)
  RELOC_NUMBER (R_FLARE32_PSEUDO_ADD32, 16)
  RELOC_NUMBER (R_FLARE32_PSEUDO_ADD64, 17)
  RELOC_NUMBER (R_FLARE32_PSEUDO_SUB8, 18)
  RELOC_NUMBER (R_FLARE32_PSEUDO_SUB16, 19)
  RELOC_NUMBER (R_FLARE32_PSEUDO_SUB32, 20)
  RELOC_NUMBER (R_FLARE32_PSEUDO_SUB64, 21)
  /* -------- */
