...
START_RELOC_NUMBERS (elf_flare32_reloc_type)
  ...
  RELOC_NUMBER (R_FLARE32_PSEUDO_ADD16, 14)
  RELOC_NUMBER (R_FLARE32_PSEUDO_ADD32, 15)
  RELOC_NUMBER (R_FLARE32_PSEUDO_ADD64, 16)
  RELOC_NUMBER (R_FLARE32_PSEUDO_SUB8, 17)
  RELOC_NUMBER (R_FLARE32_PSEUDO_SUB16, 18)
  RELOC_NUMBER (R_FLARE32_PSEUDO_SUB32, 19)
  RELOC_NUMBER (R_FLARE32_PSEUDO_SUB64, 20)
  /* -------- */
