...
START_RELOC_NUMBERS (elf_snowhousecpu_reloc_type)
  ...
  RELOC_NUMBER (R_SNOWHOUSECPU_SHIFT_U5, 10)
  //--------
  RELOC_NUMBER (R_SNOWHOUSECPU_S16_PCREL, 15)
  RELOC_NUMBER (R_SNOWHOUSECPU_S32_FOR_S16_PCREL, 16)
  //RELOC_NUMBER (R_SNOWHOUSECPU_S32_FOR_S16_PCREL_NO_RELAX, 16)
  /* -------- */
  //RELOC_NUMBER (R_SNOWHOUSECPU_FDE_32_PCREL, 27) /* `.eh_frame` stuff */
  /* -------- */
  RELOC_NUMBER (R_SNOWHOUSECPU_SET8, 17)
  RELOC_NUMBER (R_SNOWHOUSECPU_SET16, 18)
  RELOC_NUMBER (R_SNOWHOUSECPU_SET32, 19)
  /* -------- */
  /* Local label subtraction within a pseudo-op */
  RELOC_NUMBER (R_SNOWHOUSECPU_PSEUDO_ADD8, 20)
  RELOC_NUMBER (R_SNOWHOUSECPU_PSEUDO_ADD16, 21)
  RELOC_NUMBER (R_SNOWHOUSECPU_PSEUDO_ADD32, 22)
  RELOC_NUMBER (R_SNOWHOUSECPU_PSEUDO_ADD64, 23)
  RELOC_NUMBER (R_SNOWHOUSECPU_PSEUDO_SUB8, 24)
  RELOC_NUMBER (R_SNOWHOUSECPU_PSEUDO_SUB16, 25)
  RELOC_NUMBER (R_SNOWHOUSECPU_PSEUDO_SUB32, 26)
  RELOC_NUMBER (R_SNOWHOUSECPU_PSEUDO_SUB64, 27)
  /* -------- */
  RELOC_NUMBER (R_SNOWHOUSECPU_CFA_SET6, 28)
  RELOC_NUMBER (R_SNOWHOUSECPU_CFA_SUB6, 29)
  /* -------- */
  RELOC_NUMBER (R_SNOWHOUSECPU_EH_32_PCREL, 30)
  /* -------- */
